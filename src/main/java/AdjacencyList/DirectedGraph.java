...
public class DirectedGraph<A extends DirectedNode> extends AbstractListGraph<A> implements IDirectedGraph<A> {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n************\nTests\n");
		System.out
				.println("isArc() (expected : false) - result : " + al.isArc(new DirectedNode(0), new DirectedNode(1)));
		System.out.println(
				"isArc() [0][3] (expected : true) - result : " + al.isArc(new DirectedNode(0), new DirectedNode(3)));
