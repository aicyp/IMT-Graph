...
public class AdjacencyMatrixUndirectedGraph extends AbstractMatrixGraph<UndirectedNode> implements IUndirectedGraph {
	...
	public static void main(String[] args) {
		...
		System.out.println("\n************\nTests\n");
		System.out.println(
				"isEdge() (expected : false) - result : " + am.isEdge(new UndirectedNode(0), new UndirectedNode(0)));
		System.out.println(
				"isEdge() (expected : true) - result : " + am.isEdge(new UndirectedNode(2), new UndirectedNode(5)));

		System.out.println(
				"Number of edges on [3][2] : " + am.getNumberOfEdges(new UndirectedNode(3), new UndirectedNode(2)));
		am.addEdge(new UndirectedNode(3), new UndirectedNode(2));
		am.addEdge(new UndirectedNode(3), new UndirectedNode(2));
		System.out.println("Number of edges on [3][2] (expected : 3) - result : "
				+ am.getNumberOfEdges(new UndirectedNode(3), new UndirectedNode(2)));
